...
public class IntercityTravelController {
    ...
    @RequestLog(moduleName = "城际出行",functionName = "获取城际高铁列表")
    ...
    @RequestLog(moduleName = "城际出行",functionName = "获取城际客车列表")
    ...
    @RequestLog(moduleName = "城际出行",functionName = "获取城际船舶列表")
    ...
    @RequestLog(moduleName = "城际出行",functionName = "获取城际航空列表")
    ...
    @RequestLog(moduleName = "城际出行",functionName = "获取城际私家车列表")
